    ...
    if (profiles.isEmpty) {
      ...
      final sampleProfiles = [
        ...
        UserProfile(
          ...
          phone: '+1234567890',
          dateOfBirth: DateTime(1980, 8, 22),
          gender: 'Male',
          relation: 'Spouse',
        ),
        UserProfile(
      ...
      await saveProfiles(sampleProfiles);
      ...
      final sampleRecords = [
        VaccinationRecord(
          ...
          dateAdministered: DateTime(2023, 6, 15),
        ...
        VaccinationRecord(
          ...
          dateAdministered: DateTime(2023, 8, 20),
          clinicName: 'Pediatric Care Center',
          batchNumber: 'MMR5678',
      ...
      await saveAppointments(sampleAppointments);

      // Set current user
      await setCurrentUserPhone('+1234567890');
    }
  }
